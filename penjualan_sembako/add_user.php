...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO users (username, password, role_id) VALUES ('$username_safe', '$hashed_password', '$role_id_safe')";

    if ($conn->query($sql) === TRUE) {
        $_SESSION['message'] = "Pengguna '<b>" . htmlspecialchars($username) . "</b>' berhasil ditambahkan.";
...
<head>
    ...
    <title>Tambah Pengguna Baru - Toko Sembako</title>
