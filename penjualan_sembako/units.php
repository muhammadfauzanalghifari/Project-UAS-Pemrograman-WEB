...
// Query untuk mengambil semua data dari tabel 'units'
// === PENTING: Pastikan nama tabel adalah 'units' dan nama kolom untuk ORDER BY adalah 'unit_name' ===
...
<head>
    ...
    <title>Manajemen Satuan - Toko Sembako</title>
...
<body>
    ...
    <div class="container mt-4">
        <h2>Manajemen Satuan Produk</h2>

        <?php include 'includes/message.php'; // Tampilkan pesan ?>

        <a href="add_unit.php" class="btn btn-primary mb-3">Tambah Satuan Baru</a>

        <?php if ($result && $result->num_rows > 0): // Tambahkan cek $result agar tidak error jika query gagal ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="delete_unit.php?id=<?php echo $row['unit_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus satuan ini?');">Hapus</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
        ...
        <?php else: ?>
        <div class="alert alert-info">Belum ada data satuan. Silakan tambahkan satuan baru.</div>
        <?php endif; ?>
