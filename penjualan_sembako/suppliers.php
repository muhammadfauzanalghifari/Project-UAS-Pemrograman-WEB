...
require_once 'includes/message.php'; // Untuk menampilkan pesan sukses/error

// Query untuk mengambil semua data dari tabel 'suppliers'
$sql = "SELECT * FROM suppliers ORDER BY supplier_name ASC"; // Urutkan berdasarkan nama
...
<head>
    ...
    <title>Manajemen Pemasok - Toko Sembako</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="dashboard.php">Toko 511o</a>
    ...
    <div class="container mt-4">
        ...
        <a href="add_supplier.php" class="btn btn-primary mb-3">Tambah Pemasok Baru</a>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_supplier.php?id=<?php echo $row['supplier_id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="delete_supplier.php?id=<?php echo $row['supplier_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus pemasok ini?');">Hapus</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
        ...
        <?php else: ?>
        <div class="alert alert-info">Belum ada data pemasok. Silakan tambahkan pemasok baru.</div>
        <?php endif; ?>
